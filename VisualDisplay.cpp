...
void VisualDisplay::load(char *file_name)
{
    ...
    open_bracket = imread("open_bracket.png");
    close_bracket = imread("close_bracket.png");
    ...
    button[0].org_img = imread("radio_button.png"); //button  0 (backtrack)
    ...
    button[3].org_img = imread("checkbox_unchecked.png"); //random check button
    ...
    button[4].org_img = imread("checkbox_unchecked.png"); //domain show check button
    ...
    button[5].org_img = imread("checkbox_unchecked.png"); //ordering check button
    button[5].hov_img = imread("checkbox_unchecked.png");
    button[5].clk_img = imread("checkbox_checked.png");
    ...
    button[6].org_img = imread("next.png"); //next button (move one step forward)
    button[6].hov_img = imread("next_hover.png");
    button[6].clk_img = imread("next.png");
    ...
    button[7].org_img = imread("back.png"); //back button  (move one step backward)
    button[7].hov_img = imread("back_hover.png");
    button[7].clk_img = imread("back.png");
